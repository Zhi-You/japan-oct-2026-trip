...
export function Hero({ meta, todayDayId }: HeroProps) {
  ...
  return (
    <section className="relative overflow-hidden bg-banner text-banner-fg">
      ...
      <div className="relative mx-auto max-w-5xl px-4 py-14 sm:px-6 md:py-28">
        <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-banner-fg/20 bg-banner-fg/10 px-4 py-1.5 text-sm backdrop-blur-sm">
        ...
        <p className="mt-4 max-w-2xl text-lg text-banner-fg/80 md:text-xl">{meta.subtitle}</p>
        ...
        <div className="mt-8 flex flex-col gap-3 sm:mt-10 sm:flex-row sm:flex-wrap sm:gap-4">
          ...
          <a
            href="#bookings"
            className="min-h-11 rounded-lg border border-banner-fg/30 px-6 py-3 text-center font-medium text-banner-fg transition hover:bg-banner-fg/10"
          >
            {t('hero.ctaBookings')}
          </a>
        </div>
